...
type APIKeys struct {
	TextProviders  map[string]string // type checked in internal/user/service.go to textgen.ProviderType
	ImageProviders map[string]string // type checked in internal/user/service.go to imagegen.ProviderType
}
